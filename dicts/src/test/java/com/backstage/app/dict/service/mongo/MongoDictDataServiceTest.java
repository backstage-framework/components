...
public class MongoDictDataServiceTest extends CommonDictDataServiceTest
{
	...
	{
		createDictItemWithDefaultFields("testDict1");
	}

	@Test
	void createDictItemWithIncorrectStringFieldSize()
	{
		createDictItemWithIncorrectStringFieldSize("testDict1");
	}

	@Test
	void createDictItemWithIncorrectIntegerFieldSize()
	{
		createDictItemWithIncorrectIntegerFieldSize("testDict1");
	}

	@Test
	void createDictItemWithIncorrectDecimalFieldSize()
	{
		createDictItemWithIncorrectDecimalFieldSize("testDict1");
	}
}
