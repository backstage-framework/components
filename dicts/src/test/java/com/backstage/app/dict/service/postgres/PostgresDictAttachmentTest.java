...
@Order(TestPipeline.POSTGRES_DICT_ATTACHMENT)
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
@PostgresStorage
public class PostgresDictAttachmentTest extends CommonDictAttachmentTest
{
	@BeforeAll
	public void createProstresTestableHierarchy()
	{
		initTestableHierarchy(POSTGRES_DICT_ID);
	}
