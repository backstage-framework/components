...
public class CommonDictValidationServiceTest extends CommonTest
{
	...
	protected void validateSchemaIncorrectFieldsIdMaxLength()
	{
		...
		assertThrows(FieldValidationException.class, () -> dictValidationService.validateDictScheme(DICT_SCHEME, dictService));
	}
	...
	protected void validateSchemeEngineNotNull()
	{
		...
		assertThrows(EngineException.class, () -> dictValidationService.validateDictScheme(DICT_SCHEME, dictService));
