...
import com.backstage.app.dict.service.query.MongoTranslator;
import com.backstage.app.dict.service.query.QueryParser;
import com.backstage.app.dict.service.query.ast.Empty;
...
public class MongoDictDataBackend extends AbstractMongoBackend implements DictDataBackend
{
	...
	private MongoClause completedMongoClauses(List<DictFieldName> requiredFields, HashSet<String> joinFields, Query query,
	                                          MongoQuery queryContext, LinkedList<AggregationOperation> operations, Pageable pageable, String dictId)
	{
	...
	private List<Document> getDocuments(String dictId, QueryExpression queryExpression, Set<String> joinFields,
	                                    List<AggregationOperation> operations, Query query, MongoQuery queryContext)
	{
