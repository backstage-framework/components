...
public interface DictDataServiceAdvice
{
	...
	default void handleBeforeCreate(Dict dict, DictItem item)
	{
	}
	...
	default void handleBeforeCreateMany(Dict dict, List<DictItem> items)
	{
	...
	default void handleUpdate(Dict dict, DictItem oldItem, DictItem item)
	{
	}
