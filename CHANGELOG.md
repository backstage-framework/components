...
## 5.1.21 - 2025-02-24
### Audit
- Фикс изменения модели хранения аудита.

## 5.1.20 - 2025-02-24
### Dicts
- Добавили возможность экспорта справочника по фильтру.
- Переработан экспорт справочников в SQL, добавлена поддержка JSON и GeoJSON.
- Исправлен экспорт справочников в CSV, null поля выгружаются как пустые строки.
- Исправлена ошибка при создании элемента справочника с JSON полем в значении null.
- Исправлена работа сортировки в бэкэнде PostgreSQL.
