...
package com.backstage.app.database.configuration.db;

import com.backstage.app.database.configuration.properties.ClickHouseProperties;
...
public class ClickHouseConfiguration
{
	...
	{
		// TODO: временно ставим размер пула исходя из (main connection + system connection) * 2
		// Т.к. сейчас в реализации flyway-clickhouse присутствует баг, из-за которого коннекшен не возвращается обратно в пул
