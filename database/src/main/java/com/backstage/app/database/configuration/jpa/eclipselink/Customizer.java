...
package com.backstage.app.database.configuration.jpa.eclipselink;

import com.backstage.app.configuration.properties.AppProperties;
import com.backstage.app.database.configuration.jpa.eclipselink.annotation.ReadOnlyFieldAnnotationExtension;
import com.backstage.app.database.configuration.jpa.eclipselink.postgis.GeolatteExtension;
import com.backstage.app.database.configuration.jpa.eclipselink.schema.SpringAwareTableSchemaResolvingExtension;
