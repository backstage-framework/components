...
/**
 * Публичный клиент для работы с данными.
 */
@FeignClient(value = RemoteServices.DICTS, path = "/api/dicts", contextId = "externalDictDataService")
public interface ExternalDictDataService extends GenericDictDataService<DictItemDto>
{
}
