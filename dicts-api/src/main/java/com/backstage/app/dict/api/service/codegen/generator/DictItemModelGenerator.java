...
public class DictItemModelGenerator
{
	...
	public TypeSpec generate(DictDto dict)
	{
		...
		typeSpec.addMethod(addToMapMethod(fieldSpecMapping));

		return typeSpec.build();
	}

	protected MethodSpec addConstructor(Map<FieldSpec, DictFieldDto> fieldSpecMapping)
	{
	...
	protected MethodSpec addToMapMethod(Map<FieldSpec, DictFieldDto> fieldSpecMapping)
	{
	...
	protected TypeSpec addEnum(DictEnumDto dictEnum)
	{
	...
	protected FieldSpec addField(DictFieldDto dictField)
	{
	...
	protected FieldSpec addConstant(DictFieldDto dictField)
	{
