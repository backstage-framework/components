...
import com.backstage.app.attachment.conversion.dto.AttachmentConverter;
...
public class AttachmentEndpoint
{
	                                  ...
	                                  @RequestParam(defaultValue = "false") boolean view)
	{
		...
		return ResponseEntity.ok()
				.header(HttpHeaders.CONTENT_DISPOSITION, HttpUtils.buildContentDisposition(view, attachment.getId(), attachment.getFileName()))
