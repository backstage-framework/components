...
import com.backstage.app.api.configuration.properties.CaptchaProperties;
import com.backstage.app.api.model.dto.CaptchaTokenRequest;
...
public class CaptchaRequestBodyAdvise implements RequestBodyAdvice
{
	...
	public Object afterBodyRead(Object body, HttpInputMessage inputMessage, MethodParameter parameter, Type targetType, Class<? extends HttpMessageConverter<?>> converterType)
	{
		if (advises.stream().allMatch(it -> it.isCaptchaEnabled((CaptchaTokenRequest) body)))
		{
			...
			{
				throw new AppException(CoreAppStatusCode.CAPTCHA_CHECK_ERROR);
			}
		}
