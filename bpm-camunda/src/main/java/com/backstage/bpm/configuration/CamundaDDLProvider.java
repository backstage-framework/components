...
@Configuration
@Order(CamundaDDLProvider.PRECEDENCE)
public class CamundaDDLProvider extends AbstractDDLProvider
{
	public static final int PRECEDENCE = DDLConfiguration.DDL_PRECEDENCE_SYSTEM + 65;

	@Autowired
	public CamundaDDLProvider(@DDLDataSource DataSource dataSource, BpmProperties bpmProperties)
	{
		super("bpm_camunda", bpmProperties.getDdl(), dataSource);
	}
}
